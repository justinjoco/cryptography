...
"4cc5d4becb3e42b6", "597f299cfc657e2a", "5fcb6fab3ad6faec", "6c44198c4a475817" ]
	...
	for n in range(0,bv4.length(),1024):
	    ...
	    #                                   64-bits long.  As shown below, the first 16 words of the 
	    #                                   message schedule are obtained directly from the 1024-bit 
	    #                                   input block:
	    ...
	    #                                   each 1024-bit input message block.  There are a total of 
	    #                                   80 rounds and the calculations carried out in each round 
...
def main():
	...
	if (len(sys.argv) != 2):
		print("You need to have one input file")
		sys.exit()
	...
	print("My SHA-512 implementation:")
	my_hash = my_sha_512(message)
	print(my_hash)

	print("")

	print("Python's hashlib SHA-512 implementation:")
	real_hash = hashlib.sha512(message).hexdigest()
	print(real_hash)

	print("")
	print("Does my implementation match hashlib's?")
